...
class BaseWriteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'notify_via_sms' : forms.CheckboxInput(),
    ...
    def save(self, recipient=None, parent=None, auto_moderators=[]):
        ...
        if self.cleaned_data.get('notify_via_sms'):

            self.instance.notify_via_sms = self.cleaned_data.get('notify_via_sms')
...
class WriteForm(BaseWriteForm):
    ...
    class Meta(BaseWriteForm.Meta):
        fields = ('recipients', 'subject', 'body','notify_via_sms')
