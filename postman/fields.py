...
class BasicCommaSeparatedUserField(CharField):
    ...
    def clean(self, value):
        ...
        unknown_names1 = list(unknown_names)
        ...
        if unknown_names:
            ...
            if set(unknown_names1).issubset(set(user_group)):
                temp1 = [str(j) for j in unknown_names1]
                for j in temp1:
                    group = Group.objects.get(name=j)
                    users1 = list(group.user_set.all())
