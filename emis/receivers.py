...
from emis_account.signals import password_changed
from emis_account.signals import user_sign_up_attempt, user_signed_up
from emis_account.signals import user_login_attempt, user_logged_in
