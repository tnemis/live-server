    ...
    bi = i(r),
        function (n, t) {
            ...
            var ut, e, ht, r, ct, hi, kt, lt, g, nt, s, a, v, h, tt, at, ot, o = "sizzle" + -new Date,
                ...
                gt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|mandatory|scoped",
                f = "[\\x20\\t\\r\\n\\f]",
                et = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
                pi = et.replace("w", "w#"),
                wi = "\\[" + f + "*(" + et + ")" + f + "*(?:([*^$|!~]?=)" + f + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + pi + ")|)|)" + f + "*\\]",
    ...
    function (n) {
        n.extend(n.fn, {
            ...
            rules: function (t, i) {
                ...
                return u = n.validator.normalizeRules(n.extend({}, n.validator.classRules(r), n.validator.attributeRules(r), n.validator.dataRules(r), n.validator.staticRules(r)), r), u.mandatory && (h = u.mandatory, delete u.mandatory, u = n.extend({
                    mandatory: h
                }, u)), u
            }
        });
        ...
        n.extend(n.validator, {
            ...
            prototype: {
                ...
                optional: function (t) {
                    ...
                    return !n.validator.methods.mandatory.call(this, i, t) && "dependency-mismatch"
                },
            ...
            attributeRules: function (t) {
                var u = {},
                    ...
                    r, i;
                for (r in n.validator.methods) "mandatory" === r ? (i = e.get(0)
