...
urlpatterns = patterns('',
    ...
    url(
        regex=r'^Child_detail_Sectionwise_ListView/(?P<cl_id>\d+?)/(?P<sec_id>\w+?)/$',
        view=login_required(Child_detail_Sectionwise_ListView.as_view()),
        name='Child_detail_Sectionwise_ListView'
    ),
