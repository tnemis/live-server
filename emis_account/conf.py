...
class AccountAppConf(AppConf):
    ...
    DELETION_MARK_CALLBACK = "emis_account.callbacks.account_delete_mark"
    DELETION_EXPUNGE_CALLBACK = "emis_account.callbacks.account_delete_expunge"
    DELETION_EXPUNGE_HOURS = 48
    HOOKSET = "emis_account.hooks.AccountDefaultHookSet"
