...
class state_level_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			dse_school_list=School.objects.filter(management_id__in=[1,4,5],category_id__in=[3,5,6,7,8,9,10])
			...
			p_a_school_list=School.objects.filter(management_id__in=[6],category_id__in=[3,5,6,7,8,9,10])
			...
			p_u_school_list=School.objects.filter(management_id__in=[8],category_id__in=[3,5,6,7,8,9,10])
			...
			matriculation_school_list=School.objects.filter(management_id__in=[9],category_id__in=[3,5,6,7,8,9,10])
			...
			cbse_school_list=School.objects.filter(management_id__in=[7,10,11],category_id__in=[3,5,6,7,8,9,10])
...
# dee
			...
			dee_school_list=School.objects.filter(management_id__in=[3,4,5],category_id__in=[1,2,4,11,15])
			...
			d_p_a_school_list=School.objects.filter(management_id__in=[6],category_id__in=[1,2,4,11,15])
			...
			nursery_school_list=School.objects.filter(management_id__in=[8],category_id__in=[1,2,4,11,15])
			...
			return render(request,'state/aadhaar_report.html',locals())
...
# dee
			...
			return render(request,'state/s_l_aadhaar_dee_report.html',locals())
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in dist_list:	
				...
				dist=School.objects.filter(district_id=i.id,management_id__in=[9],category_id__in=[3,5,6,7,8,9,10])				
			...
			a_list=zip(district_ids,district_names,m_emis,m_aadhaar,m_not_aadhaar)
			return render(request,'state/aadhaar_matric.html',locals())
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in blocks:
				...
				school_list=School.objects.filter(block_id=i.id,management_id__in=[9],category_id__in=[3,5,6,7,8,9,10])
			...
			a_list=zip(block_ids,block_names,m_b_emis,m_b_aadhaar,m_b_not_aadhaar)
			return render(request,'district/district_matric_aadhaar_report.html',locals())
...
class Block_level_matric_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			school_list=School.objects.filter(block_id=block,management_id__in=[9],category_id__in=[3,5,6,7,8,9,10]).order_by('school_name')
			...
			return render(request,'block/block_matric_aadhaar_report.html',locals())
...
class School_matric_aadhaar_report(View):
    def get(self,request,**kwargs):
        ...
        return render(request,'school/school_aadhar_report.html',locals())


class dee_govt_view(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			dee_govt_school_list=School.objects.filter(management_id__in=[3,4,5],category_id__in=[1,2,4,11,15])
			...
			for i in dist_list:	
				district_ids.append(str(i.id))
				district_names.append(i.district_name)
				dist=School.objects.filter(district_id=i.id,management_id__in=[3,4,5],category_id__in=[1,2,4,11,15])
			...
			return render(request,'state/aadhaar_dee_govt.html',locals())
...
class dee_govt_Dist_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			dee_g_blk_emis=[]
			dee_g_blk_aadhaar=[]
			dee_g_blk_not_aadhaar=[]
			for i in blocks:
				block_ids.append(str(i.id))
				block_names.append(i.block_name)
				school_list=School.objects.filter(block_id=i.id,management_id__in=[3,4,5],category_id__in=[1,2,4,11,15])
			...
			a_list=zip(block_ids,block_names,dee_g_blk_emis,dee_g_blk_aadhaar,dee_g_blk_not_aadhaar)
			return render(request,'district/dee_govt_dist_aadhaar_report.html',locals())
...
class dee_govt_block_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[3,4,5],category_id__in=[1,2,4,11,15])
			...
			return render(request,'block/dee_govt_block_aadhaar_report.html',locals())
...
class dee_govt_school_aadhaar_report(View):
    def get(self,request,**kwargs):
        ...
        return render(request,'school/dee_govt_schl_aadhaar_report.html',locals())
...
class dee_pvt_aid_view(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			dee_pvt_aided_not_aadhaar=[]
			

			for i in dist_list:	
				district_ids.append(str(i.id))
				district_names.append(i.district_name)
				dist=School.objects.filter(district_id=i.id,management_id__in=[6],category_id__in=[3,5,6,7,8,9,10])
			...
			a_list=zip(district_ids,district_names,dee_pvt_aided_emis,dee_pvt_aided_aadhaar,dee_pvt_aided_not_aadhaar)
			return render(request,'state/aadhaar_dee_pvt_aided.html',locals())
...
class dee_pvt_aided_Dist_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			dee_pvt_aid_blk_not_aadhaar=[]
			for i in blocks:
				block_ids.append(str(i.id))
				block_names.append(i.block_name)
				school_list=School.objects.filter(block_id=i.id,management_id__in=[6],category_id__in=[3,5,6,7,8,9,10])
			...
			a_list=zip(block_ids,block_names,dee_pvt_aid_blk_emis,dee_pvt_aid_blk_aadhaar,dee_pvt_aid_blk_not_aadhaar)
			return render(request,'district/dee_pvt_aided_dist_aadhaar_report.html',locals())
...
class dee_pvt_aided_block_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[6],category_id__in=[3,5,6,7,8,9,10])
			...
			return render(request,'block/dee_pvt_aided_block_aadhaar_report.html',locals())
...
class dee_pvt_aided_school_aadhaar_report(View):
    def get(self,request,**kwargs):
        ...
        return render(request,'school/dee_pvt_aided_schl_aadhaar_report.html',locals())
...
class dee_pvt_unaid_view(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			dee_pvt_unaided_not_aadhaar=[]
			

			for i in dist_list:	
				district_ids.append(str(i.id))
				district_names.append(i.district_name)
				dist=School.objects.filter(district_id=i.id,management_id__in=[8],category_id__in=[3,5,6,7,8,9,10])
			...
			a_list=zip(district_ids,district_names,dee_pvt_unaided_emis,dee_pvt_unaided_aadhaar,dee_pvt_unaided_not_aadhaar)
			return render(request,'state/aadhaar_dee_pvt_unaided.html',locals())
...
class dee_pvt_unaided_Dist_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			dee_pvt_unaid_blk_not_aadhaar=[]
			for i in blocks:
				block_ids.append(str(i.id))
				block_names.append(i.block_name)
				school_list=School.objects.filter(block_id=i.id,management_id__in=[8],category_id__in=[3,5,6,7,8,9,10])
			...
			return render(request,'district/dee_pvt_unaided_dist_aadhaar_report.html',locals())
...
class dee_pvt_unaided_block_aadhaar_report(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[8],category_id__in=[3,5,6,7,8,9,10])
			...
			return render(request,'block/dee_pvt_unaided_block_aadhaar_report.html',locals())
...
class dee_pvt_unaided_school_aadhaar_report(View):
    def get(self,request,**kwargs):
        ...
        return render(request,'school/dee_pvt_unaided_schl_aadhaar_report.html',locals())
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in dist_list:	
				district_ids.append(str(i.id))				
				district_names.append(i.district_name)
				dist=School.objects.filter(district_id=i.id,management_id__in=[1,4,5],category_id__in=[3,5,6,7,8,9,10])
			...
			a_list=zip(district_ids,district_names,dse_g_emis,dse_g_aadhaar,dse_g_not_aadhaar)
			return render(request,'state/aadhaar_dse_g_state.html',locals())
...
class dse_pvt_a_view(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			a_list=zip(district_ids,district_names,dse_gpa_emis,dse_gpa_aadhar,dse_gpa_not_aadhar)
			return render(request,'state/aadhaar_dse_p_a_state.html',locals())
...
class dse_pvt_ua_view(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			return render(request,'state/aadhaar_dse_p_ua_state.html',locals())
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in dist_list:	
				district_ids.append(str(i.id))				
				district_names.append(i.district_name)
				dist=School.objects.filter(district_id=i.id,management_id__in=[7,10,11],category_id__in=[3,5,6,7,8,9,10])
				...
				cbse__emis+=x.values()
				cbse__aadhaar+=y.values()			
			# cbse__not_aadhaar=[i-j for i,j in zip(cbse__emis,cbse__aadhaar)]			
			a_list=zip(district_ids,district_names,cbse__emis,cbse__aadhaar)#cbse__not_aadhaar
			return render(request,'state/aadhaar_cbse_state.html',locals())			
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in blocks:
				block_ids.append(str(i.id))
				block_names.append(i.block_name)
				school_list=School.objects.filter(block_id=i.id,management_id__in=[1,4,5],category_id__in=[3,5,6,7,8,9,10])
				a_d_matric=aadhaar_student_count.objects.filter(school_id__in=school_list)
				x=a_d_matric.aggregate(Sum('school_total'))
				y=a_d_matric.aggregate(Sum('a_school_total'))
			...
			a_list=zip(block_ids,block_names,dse_g_b_emis,dse_g_b_aadhaar,dse_g_b_not_aadhaar)
			return render(request,'district/d_l_dse_govt_aadhaar.html',locals())
...
class d_l_dse_a_addhaar(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			a_list=zip(block_ids,block_names,dse_a_b_emis,dse_a_b_aadhaar,dse_a_b_not_aadhaar)
			return render(request,'district/d_l_dse_govt_a_aadhaar.html',locals())
...
class d_l_dse_ua_addhaar(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			a_list=zip(block_ids,block_names,dse_ua_b_emis,dse_ua_b_aadhaar,dse_ua_b_not_aadhaar)
			return render(request,'district/d_l_dse_govt_ua_aadhaar.html',locals())
	...
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			for i in blocks:
				block_ids.append(str(i.id))
				block_names.append(i.block_name)
				school_list=School.objects.filter(block_id=i.id,management_id__in=[7,10,11],category_id__in=[3,5,6,7,8,9,10])
				a_d_matric=aadhaar_student_count.objects.filter(school_id__in=school_list)
				x=a_d_matric.aggregate(Sum('school_total'))
				y=a_d_matric.aggregate(Sum('a_school_total'))
			...
			a_list=zip(block_ids,block_names,cbse_b_emis,cbse_b_aadhaar,cbse_b_not_aadhaar)
			return render(request,'district/d_l_cbse_aadhaar.html',locals())
...
class b_l_dse_g_aadhar(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[1,4,5],category_id__in=[3,5,6,7,8,9,10]).order_by('school_name')
			a_bl_matric=aadhaar_student_count.objects.filter(school_id__in=school_list)
			m_block_emis=a_bl_matric.aggregate(Sum('school_total')).values()[0]
			m_block_aadhaar=a_bl_matric.aggregate(Sum('a_school_total')).values()[0]			
			return render(request,'block/b_l_dse_govt_aadhar.html',locals())
...
class b_l_dse_a_aadhaar(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[6],category_id__in=[3,5,6,7,8,9,10]).order_by('school_name')
			a_bl_matric=aadhaar_student_count.objects.filter(school_id__in=school_list)
			m_block_emis=a_bl_matric.aggregate(Sum('school_total')).values()[0]
			m_block_aadhaar=a_bl_matric.aggregate(Sum('a_school_total')).values()[0]			
			return render(request,'block/b_l_dse_govt_a_aadhar.html',locals())
...
class b_l_dse_ua_aadhaar(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			block=self.kwargs['pk']
			block_name=Block.objects.get(id=block)
			school_list=School.objects.filter(block_id=block,management_id__in=[8],category_id__in=[3,5,6,7,8,9,10]).order_by('school_name')
			a_bl_matric=aadhaar_student_count.objects.filter(school_id__in=school_list)
			m_block_emis=a_bl_matric.aggregate(Sum('school_total')).values()[0]
			m_block_aadhaar=a_bl_matric.aggregate(Sum('a_school_total')).values()[0]			
			return render(request,'block/b_l_dse_govt_ua_aadhar.html',locals())
...
class b_l_cbse(View):
	def get(self,request,**kwargs):
		if request.user.is_authenticated():
			...
			m_block_emis=a_bl_matric.aggregate(Sum('school_total')).values()[0]
			m_block_aadhaar=a_bl_matric.aggregate(Sum('a_school_total')).values()[0]			
			return render(request,'block/b_l_cbse_aadhar.html',locals())
...
class s_l_dse_govt_aadhaar(View):
    def get(self,request,**kwargs):
        ...
        school=self.kwargs['pk']        
        aadhaar=aadhaar_student_count.objects.get(id=school)        
        return render(request,'school/s_l_dse_govt_aadhaar.html',locals())
...
class s_l_dse_a_aadhaar(View):
    def get(self,request,**kwargs):
        ...
        school=self.kwargs['pk']        
        aadhaar=aadhaar_student_count.objects.get(id=school)        
        return render(request,'school/s_l_dse_a_aadhaar.html',locals())
...
class s_l_dse_ua_aadhaar(View):
    def get(self,request,**kwargs):
        ...
        school=self.kwargs['pk']        
        aadhaar=aadhaar_student_count.objects.get(id=school)        
        return render(request,'school/s_l_dse_ua_aadhaar.html',locals())
...
class s_l_cbse_aadhaar(View):
    def get(self,request,**kwargs):
        ...
        school=self.kwargs['pk']        
        aadhaar=aadhaar_student_count.objects.get(id=school)        
        return render(request,'school/s_l_cbse_aadhaar.html',locals())        
